...
import { Shuffle, RotateCcw, Settings, Undo2 } from "lucide-react";
                ...
                {buttons.map((button) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {/* Counter Badge for Undo */}
                            {button.badge !== null && (
                                <span className="absolute -top-1 -right-1 w-5 h-5 rounded-full bg-gradient-to-br from-primary to-secondary text-white text-xs font-bold flex items-center justify-center border-2 border-white shadow-lg">
                                    {button.badge}
                                </span>
                            )}
                        </motion.button>
